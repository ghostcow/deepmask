...
output_dir_name=CFW_PubFig_SUFR_deepID.3.64_15patches
patch_dir=patch$patch_index
output_dir_name=$output_dir_name/$patch_dir
echo $output_dir_name

model_name='model_deepID.3.64'
th doall.lua --deepIdMode 2 --patchIndex $patch_index --dataPath $data_path --save $output_dir_name --modelName $model_name --learningRate 0.01 --batchSize 64 --loadState