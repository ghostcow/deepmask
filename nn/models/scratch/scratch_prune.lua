...
function createModel()
    ...
    model:add(cudnn.SpatialConvolution(16, 64, 3, 3, 1, 1, 1, 1)) --3
    model:add(cudnn.ReLU(true))
    ...
    -- Conv41 & Conv42
    model:add(cudnn.SpatialConvolution(192, 128, 3, 3, 1, 1, 1, 1))
    model:add(cudnn.ReLU(true))
    ...
    -- Conv51 & Conv52
    model:add(cudnn.SpatialConvolution(256, 160, 3, 3, 1, 1, 1, 1))
    model:add(cudnn.ReLU(true))
